...
void AddCar() {
    ...
    do {
        ...
        if (!qstate) {
            ...
            if (res && (row = mysql_fetch_row(res))) {
                ...
                cout << "\n\n" << setw(85) << "Invalid CatID! Please enter a valid category ID.\n";

                // Prompt the user for yes/no to retry
                cout << "\n" << setw(85) << "Do you want to try again? (y/n): ";
                cin >> choice;
    ...
    cout << "\n" << setw(69) << "Car Plate Number: ";
    getline(cin, Plate);
    cout << "\n\n" << setw(66) << "Enter Car Price: ";
    getline(cin, Price);
    ...
    if (!qstate) {
        ...
        if (!qstate) {
            ...
            cout << setw(79) << "Do you want to add another new car? (y/n): ";
            cin >> option;
...
void UpdateCar() {
    ...
    if (!qstate)
    {
        ...
        if (choose == 1)
        {
            cout << endl << endl << setw(62) << "1. Plate: ";
            getline(cin, c_data);
        ...
        {
            cout << endl << endl << setw(71) << "2. Price: ";
            getline(cin, c_data);
...
void UpdateCust() {
    ...
    if (!qstate)
    {
        ...
        cout << endl << endl << setw(72) << "  Choose Customer IC : ";
        cin >> IC;
...
void DeleteCust() {
    ...
    if (!qstate)
    {
        ...
        if (found)
        {
            ...
            if (!qstate)
            {
                cout << endl << setw(72) << "  Successfully deleted from customer record" << endl;
            }
            else
            {
                cout << "Failed to Delete" << mysql_error(conn) << endl;
        ...
        cout << endl << setw(85) << "  Do you want to delete another student? (y/n): ";
        cin >> choose;
...
void RentalMenu() {
    ...
    cout << "\n\n\n";
    cout << setw(61) << "1. Rent Car\n\n";
    cout << setw(64) << "2. Update Rent\n\n";
    cout << setw(64) << "3. Delete Rent\n\n";
    cout << setw(63) << "4. Return Car\n\n";
    cout << setw(64) << "5. Rented List\n\n";
    cout << setw(59) << "6. Search\n\n";
    cout << setw(57) << "7. Back\n\n";
    cout << setw(83) << "-------------------------------------------\n" << endl;
    cout << setw(75) << "Please Enter Your Choice : ";
    cin >> choose;
...
void  DeleteRental() {
    ...
    if (!qstate)
    {
        ...
        cout << endl << endl << setw(43) << "  Choose Customer ID : ";
        cin >> ID;
...
void ReturnCar() {
    ...
    if (!qstate)
    {
        ...
        //data show in box
        cout << setw(13) << "";
        printf("|%-15s | %-25s | %-15s | %-20s | %-10s | %-10s | %-10s |\n", "Rental ID", "Car ID", "Brand", "Plate", "Rental Date", "Return Date", "Rental Status");
        cout << setw(114) << "-------------------------------------------------------------------------------------------------------------------------------------------\n";
        ...
        cout << setw(79) << "Rental car return successfully! Update the car status? (y/n): ";
        char option;
        cin >> option;
...
void SearchRent() {
    ...
    cin.ignore(1, '\n');
    cout << setw(60) << "SEARCH rent by RentID: ";
...
void StaffPage() {
    ...
    cout << setw(61) << "2. Monitor Car\n\n" << endl;
    cout << setw(68) << "3. Update Rent Status\n\n" << endl;
    cout << setw(62) << "4. Display Rent\n\n" << endl;
    cout << setw(56) << "5. Logout\n\n" << endl;
    cout << setw(79) << "-----------------------------------------\n" << endl;
